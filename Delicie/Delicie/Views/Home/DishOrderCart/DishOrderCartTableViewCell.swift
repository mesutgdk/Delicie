//
//  DishOrderCartTableViewCell.swift
//  Delicie
//
...
//        contentView.addShadow(self) // extensionda tanımladım
    ...
    func configure(viewModel: DishOrderCartTableViewCellVM){
        
        titleLabel.text = viewModel.order.dish?.name
        descriptionLabel.text = viewModel.order.name
