...
final class OnBoardingView2ViewModel:NSObject{
    ...
    private var cellViewModels: [OnBoarding2CollectionViewCellModel] = []
    
    lazy var currentPage = 0
    
    let page1 = OnBoarding2CollectionViewCellModel(imageName: "slide1", firstText: "Quick Delivery At Your Doorstep", secondText: "Home delivery and Online rezervation system for restaurants and cafes")
    let page2 = OnBoarding2CollectionViewCellModel(imageName: "slide2", firstText: "World-Class Chefs", secondText: "Our dishes are prepared by the best")
    let page3 = OnBoarding2CollectionViewCellModel(imageName: "slide3", firstText: "Delicious Dishes", secondText: "Experince a variety of amazing dishes from different cultures around the world")
